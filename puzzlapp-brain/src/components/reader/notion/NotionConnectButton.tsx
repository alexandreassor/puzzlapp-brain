/**
 * Bouton de connexion/déconnexion Notion
 *
 * Permet à l'utilisateur de connecter son workspace Notion via OAuth
 */
...
export function NotionConnectButton({
  ...
  // Charger la connexion existante
  useEffect(() => {
    loadConnection();
  ...
  // Connecté : afficher le workspace et bouton déconnexion
  if (connection) {
    return (
              ...
              <div className="flex items-center gap-2 px-3 py-2 rounded-md bg-muted">
                ...
                {showWorkspaceName && (
                  <span className="text-sm font-medium truncate max-w-[150px]">
                    {connection.workspace_name || 'Workspace Notion'}
                  </span>
                )}
              </div>
            </TooltipTrigger>
            <TooltipContent>
              <p>Connecté à {connection.workspace_name || 'Notion'}</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Vous ne pourrez plus exporter vos livrables vers ce workspace Notion.
